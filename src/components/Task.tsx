import { TbEye, TbEyeSearch, TbPencilMinus, TbTrash } from "react-icons/tb";
...
export default function Task(props: TaskProps) {
  ...
  return (
    <main className="flex flex-row justify-between items-center w-11/12 min-h-6 max-h-6 border-b-2 border-black relative">
